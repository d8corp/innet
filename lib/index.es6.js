import { Watch, scope as scope$1 } from 'watch-state';
    ...
    if (content instanceof Node) {
        ...
        if (isContextNode(content)) {
            ...
            if (!type) {
                ...
                const watcher = scope$1.activeWatcher;
                scope$1.activeWatcher = undefined;
                if (isComponent(type)) {
                    scope.currentPlugins = plugins;
                    const component = new type(props, children);
                    if ('destructor' in component) {
                        watcher === null || watcher === void 0 ? void 0 : watcher.onDestroy(() => component.destructor());
                    }
...
export { create, dom, innet, isComponent, isContextNode, onMounted };
