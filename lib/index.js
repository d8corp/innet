...
function innet(content, parent, plugins, defaultPlugin) {
    ...
    if (content instanceof Node) {
        ...
        if (isContextNode(content)) {
            ...
            var _b = content, type = _b.type, props = _b.props, children = _b.children;
            if (!type) {
                ...
                if (isComponent(type)) {
                    ...
                    if ('destructor' in component_1) {
                        (_a = watchState.scope.activeWatcher) === null || _a === void 0 ? void 0 : _a.onDestroy(function () { return component_1.destructor(); });
                    }
